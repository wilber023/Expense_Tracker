...
class ExpenseFetch(
    private val api: com.example.expensetracker.src.feature.home.data.dataSource.local.remote.ExpenseApi = NetworkModule.expenseApi,
    ...
    suspend fun getAllExpenses(): Result<List<com.example.expensetracker.src.feature.home.data.dataSource.local.remote.ExpenseData>> {
        return try {
            val token = getToken()
            if (token == null) {
